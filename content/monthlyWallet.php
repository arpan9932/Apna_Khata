                ...
                <div class="container">
                    <table class="table">
                        <tbody>
                            ...
                            $sql = "SELECT * FROM `monthly_money` WHERE user_id=$user_id AND `soft_delete` = '0'";
                        ...
                        <tr>
                            ...
                            <td style="color: black;" ><a class="monthly_edit_btn" data-id="' .
                                $row["id"] . '"><i class="bi bi-pencil-square"></i></a></td>
                            <td style="color: black;"><a class="monthly_dlt_btn"  data-id="' .
